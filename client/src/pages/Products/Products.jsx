 ...
 console.log(selectedSubCategories);
  ...
  return (
    <div className='products'>
      ...
      <div className="left">
        ...
        <div className="filterItem"> 
          ...
          <div className="inputItem">
            ...
            <label htmlFor="asc"> Price - Lowesr first </label>
          </div>
          <div className="inputItem">
      ...
      {/* RIGHT SIDE */}
      <div className="right">
        <img className='categoryImg' src="https://images.pexels.com/photos/10679171/pexels-photo-10679171.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" />
